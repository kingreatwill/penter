...
parser.add_argument('--prototxt', help='Path to deploy.prototxt',
                    required=False)  # https://github.com/opencv/opencv/blob/master/samples/dnn/face_detector/deploy.prototxt
parser.add_argument('--caffemodel', help='Path to hed_pretrained_bsds.caffemodel',
                    required=False)  # http://vcl.ucsd.edu/hed/hed_pretrained_bsds.caffemodel
...
args = {
    ...
    "caffemodel": r"E:\bigdata\ai\opencv-4.3.0\data\hed_pretrained_bsds.caffemodel",
    "width": 500,
    "height": 500
}
